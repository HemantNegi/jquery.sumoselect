            ...
            this.sumo = {
                ...
                createElems: function() {
                    ...
                    if (settings.selectAll)
                        ul.prepend('<li  class="selectAll"><span><i></i></span><label>' + settings.selectAlltext + '</label></li>');
                    ...
                    if (settings.selectAll) O.clickselectAll(ul);
                ...
                clickselectAll: function(ul) { 
                    var O = this;
                    selectAllevent = ul.on('click','.selectAll',function() {
                ...
                isMobile: function() {
                    ...
                    for (var i in settings.nativeOnDevice)
                        if (ua.toLowerCase().indexOf(settings.nativeOnDevice[i].toLowerCase()) > 0) return settings.nativeOnDevice[i];
                    return false;
                },
                ...
                toggSelAll: function(c, i) {
                    ...
                    O.E.find('option').each(function(index, el) {
                        ...
                        var inc = 0;
                        if (settings.selectAll) inc = 1;
                        if (!O.mob) O.optDiv.find('ul.options li').eq($(this).index() + inc).toggleClass('selected', c);
                        O.setText();
                    });
                ...
                */
                ...
                unSelectAll: function(i) {
                    this.toggSelAll(false, i);
                },
                ...
                set disabled(val) {
                    ...
                    if (val) O.E.attr('disabled', 'disabled');
                    else O.E.removeAttr('disabled');
                },
