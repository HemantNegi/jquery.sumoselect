        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                isMobile: function () {
                    ...
                    for (var i = 0; i < settings.nativeOnDevice.length; i++) if (typeof settings.nativeOnDevice[i] != 'undefined' && ua.toLowerCase().indexOf(settings.nativeOnDevice[i].toLowerCase()) > 0) return settings.nativeOnDevice[i];
                    return false;
                },
